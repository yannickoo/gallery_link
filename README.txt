...
theme('gallery_link', $items, $text, $preset, $link_options = array(), $fancybox_options = array());
  ...
  $link_options - (optional) Here you can pass an array which is structured like the options from the l() function
...
<?php
  ...
  return theme('gallery_link', $images, t('Click to open gallery'), 'big' $link_options, $fancybox_options);
}
?>
